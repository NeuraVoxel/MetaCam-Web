...
const DownloadCenter: React.FC = () => {
  ...
  const [latestFirmwareVersion, setLatestFirmwareVersion] = useState<Version | null>(null);
  ...
  const hasNewAppVersion = latestAppVersion && latestAppVersion.version !== currentAppVersion;
  const hasNewFirmwareVersion = latestFirmwareVersion && latestFirmwareVersion.version !== currentFirmwareVersion;
          ...
          {activeTab === 'app' ? (
            <>
              ...
              {latestAppVersion && (
                <div className="latest-version">
                  ...
                  <p className="release-date">发布日期: {latestAppVersion.releaseDate}</p>
            ...
            <>
              ...
              {latestFirmwareVersion && (
                <div className="latest-version">
                  <h3>最新固件版本</h3>
                  <p className="version-number">{latestFirmwareVersion.version}</p>
                  <p className="release-date">发布日期: {latestFirmwareVersion.releaseDate}</p>
                  <p className="description">{latestFirmwareVersion.description}</p>
                    ...
                    <div className="update-notification">
                      ...
                      {upgrading ? (
                        <div className="upgrade-progress">
                          ...
                          <p className="progress-text">升级中: {upgradeProgress}%</p>
                        </div>
                      ) : (
                        <button 
