    ...
    const fetchProjectDetails = async () => {
      try {
        ...
        const mockProject: ProjectDetails = {
          id: id || '1',
          name: id === '1' ? '客厅扫描' : id === '2' ? '卧室建模' : '办公室测量',
          thumbnailUrl: `https://via.placeholder.com/300?text=${id === '1' ? '客厅' : id === '2' ? '卧室' : '办公室'}`,
          createdAt: '2025-04-15 14:30',
          pointsCount: 1250000,
          description: '这是一个使用MetaCam采集的3D点云项目，包含完整的空间扫描数据。',
        ...
        <div className="project-content">
          <div className="project-info-panel">
            ...
            <div className="project-metadata">
              ...
              <p className="project-points">点数量: {formatPointsCount(project.pointsCount)}</p>
